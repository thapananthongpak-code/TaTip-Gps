 ...
 *
 * ขั้นสุดท้าย 6 กิโลเมตรไกลเกินกว่าจะเดินไหว แต่ยังมีประโยชน์
 * เพราะบอกได้ว่า "สิ่งที่ใกล้ที่สุดอยู่ไกลแค่ไหน" ซึ่งช่วยให้ตัดสินใจเรียกรถแทนได้
 * ดีกว่าบอกว่าไม่พบเฉยๆ แล้วผู้ใช้ไม่รู้ว่าควรทำอย่างไรต่อ
 *
 * ยิงทีละขั้นเฉพาะตอนขั้นก่อนหน้าไม่เจอ จึงไม่ช้าในพื้นที่ที่มีข้อมูลครบ
 */
const RADIUS_STEPS_M = [NEARBY_RADIUS_M, 2500, 6000]

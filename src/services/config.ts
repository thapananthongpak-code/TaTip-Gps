 ...
 *
 * ตั้งใจให้สั้น: ตอนแรกใส่ไว้สี่ตัวเพื่อความทนทาน แต่กลายเป็นโทษ
 * เพราะ mirror ที่เข้าถึงไม่ได้ทำให้ต้องรอ timeout ทีละตัวจนรวมแล้วเป็นนาที
 * ผู้ใช้ที่ยืนรออยู่กลางทางเห็นแค่ว่า "ค้นหาไม่ได้" โดยไม่รู้ว่าระบบกำลังรออะไร
 *
 * ทดสอบซ้ำสามรอบแล้วพบว่า overpass-api.de ตอบใน 1-2 วินาทีทุกครั้ง
 * ส่วนที่เคยล่มคือผลจากการยิงทดสอบถี่เกินจนโดนบล็อกชั่วคราว ไม่ใช่บริการไม่เสถียร
 * จึงเหลือตัวหลักกับตัวสำรองหนึ่งตัว และลด timeout ลงให้ล้มเหลวเร็วแทนที่จะรอ
 *
...
/**
 * สั้นกว่าค่า timeout ในตัว query (25 วินาที) เพราะคนที่ยืนรออยู่กลางทาง
 * ควรได้คำตอบว่า "ไม่ได้" ภายในเวลาที่ยังรอไหว ดีกว่ารอครึ่งนาทีแล้วค่อยรู้
 */

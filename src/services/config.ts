...
/**
 * ความแม่นยำ GPS ที่แย่กว่านี้ (เมตร) ใช้นำทางไม่ได้
 *
 * เป็นค่าเดียวที่ใช้ตัดสินทุกเรื่องของการนำทาง ทั้งการเริ่ม การตัดสินว่าออกนอกเส้นทาง
 * และการประกาศว่าถึงจุดหมาย เคยกระจายอยู่หลายไฟล์จนเผลอตั้งไม่ตรงกัน
 * แล้วทำให้เริ่มนำทางได้แต่ไม่มีวันประกาศว่าถึง
 */
export const NAVIGATION_ACCURACY_M = 30
